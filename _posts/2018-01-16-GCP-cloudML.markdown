 ...
 * Data Set RAW
 [![Data Set RAW](/assets/img/posts/2018-01-16-GCP-cloudML/1.jpg)](#)
 
 * Data Set 설명
 [![Data Set 설명](/assets/img/posts/2018-01-16-GCP-cloudML/2.jpg)](#)

## wide & deep

 이번 예측 분석에서는 Cloud에 많은 예시 중에서 wide & deep을 이용하였다. wide & deep에 대해서 알아보고 실습해보자.
 wide 선형 모델과 deep feed-forward 신경망으로 구성된 모델이다. 
 [![wide & deep](/assets/img/posts/2018-01-16-GCP-cloudML/4.jpg)](#)
 ...
 * FoodIO ver 2.0 : wide 모델 적용
 ...
 [![FoodIO wide](/assets/img/posts/2018-01-16-GCP-cloudML/5.jpg)](#)

 * FoodIO ver 3.0 : Deep 모델 적용

 [![FoodIO deep](/assets/img/posts/2018-01-16-GCP-cloudML/6.jpg)](#)
